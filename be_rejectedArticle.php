                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<td> ';
                                    echo ' <a  type="button" class="btn btn-xs btn-warning" href="be_rejectedArticle_message.php">GIVE COMMENT</a></td> ';
