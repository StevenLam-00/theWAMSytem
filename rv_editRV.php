        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    <li><a href="<?php echo BASE_URL . 'rv_dashboard.php' ?>">Incoming Article</a>
                    </li>
                    <li class="active"><a href="<?php echo BASE_URL . 'rv_profile.php' ?>">Profile</a></li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <?php
                $sql_edit = "SELECT * FROM users WHERE username='$_SESSION[username]'";
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="phonenumber" id="phonenumber"
                                placeholder="Phone Number" value="<?php echo $_SESSION['phonenumber'] ?> " required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <textarea max="1000" class="form-control" placeholder="Address" name="address"
                                value="<?php echo $_SESSION['address'] ?>" id="address"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <textarea max="1000" class="form-control" placeholder="Employment" name="employment"
                                value="<?php echo  $_SESSION['employment'] ?>" id="employment"></textarea>
                        </div>
                    </div>
                    ...
                    if (isset($_POST['update-btn'])) {
                        ...
                        $sql_update_edit = "UPDATE users SET email='$email', academicRank = '$academicRank', phonenumber='$phonenumber', address ='$address',employment ='$employment' WHERE username='" . $_SESSION['username'] . "';";

                        if (mysqli_query($conn, $sql_update_edit)) {
                    ?>
                    <script type="text/javascript">
                    alert("Saved Successfully.");
                    window.location = "rv_profile.php";
                    </script>
                    <?php
                        }
                    }
