        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><a href="<?php echo BASE_URL . 'rs_approvedArticle.php' ?>">My Approved
                            Article</a></li>
                    <li><a name="rejectedArticle" href="<?php echo BASE_URL . 'rs_rejectedArticle.php' ?>">My Rejected
                            Article</a></li>
                </ul>
            </div>
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <form method="POST" action="">
                    <h2 class="sub-header">Approved Articles Table</h2>
